  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-[11px] font-mono text-slate-500 uppercase tracking-[0.15em]">
          Activity
        </h2>
        ...
        <AnimatePresence initial={false}>
          ...
          {recentEvents.map((event) => {
            ...
            return (
              <motion.div
                key={event.id}
                className="flex items-start gap-2.5 px-2 py-2 rounded-md hover:bg-white/[0.02] transition-colors"
