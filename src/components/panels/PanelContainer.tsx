...
function PanelAgentIcon({ name, color }: { name: string; color: string }) {
  ...
  switch (name) {
    ...
    case "hera":
      return <svg viewBox="0 0 80 80" width={18} height={18}><path d="M 40 10 C 34 8, 22 10, 16 18 C 10 26, 8 34, 10 42 C 12 50, 16 56, 22 60 C 26 62, 30 66, 34 68 C 37 69, 39 68, 40 64" {...f} stroke={color} strokeWidth="2.5" /><path d="M 40 10 C 46 8, 58 10, 64 18 C 70 26, 72 34, 70 42 C 68 50, 64 56, 58 60 C 54 62, 50 66, 46 68 C 43 69, 41 68, 40 64" {...f} stroke={color} strokeWidth="2.5" /><path d="M 40 10 Q 39 24 40 38 Q 41 52 40 64" stroke={color} strokeWidth="1.2" strokeOpacity="0.5" fill="none" /><path d="M 14 28 Q 22 22 32 26 Q 38 30 38 32" stroke={color} strokeWidth="1.5" strokeOpacity="0.45" fill="none" strokeLinecap="round" /><path d="M 66 28 Q 58 22 48 26 Q 42 30 42 32" stroke={color} strokeWidth="1.5" strokeOpacity="0.45" fill="none" strokeLinecap="round" /><path d="M 36 64 Q 38 70 40 74 Q 42 70 44 64" stroke={color} strokeWidth="2" strokeOpacity="0.6" fill={color} fillOpacity="0.15" strokeLinecap="round" /></svg>;
    case "meridian":
    ...
    case "poseidon":
      return <svg viewBox="0 0 80 80" width={18} height={18}><circle cx="42" cy="38" r="18" {...f} stroke={color} strokeWidth="2.5" /><line x1="55" y1="51" x2="70" y2="70" stroke={color} strokeWidth="3.5" strokeLinecap="round" /><circle cx="42" cy="38" r="10" stroke={color} strokeWidth="1.5" strokeOpacity="0.4" fill="none" /><circle cx="36" cy="32" r="2" fill={color} fillOpacity="0.5" /><circle cx="48" cy="44" r="2" fill={color} fillOpacity="0.5" /><line x1="36" y1="32" x2="48" y2="44" stroke={color} strokeWidth="0.8" strokeOpacity="0.4" /></svg>;
    case "iris":
