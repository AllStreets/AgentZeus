...
function PanelAgentIcon({ name, color }: { name: string; color: string }) {
  ...
  switch (name) {
    ...
    case "hera":
      return <svg viewBox="0 0 80 80" width={18} height={18}><path d="M 40 12 Q 18 12 14 30 Q 10 48 22 56 Q 16 60 20 68 Q 24 76 34 72 Q 38 70 40 66" {...f} stroke={color} strokeWidth="2.5" /><path d="M 40 12 Q 62 12 66 30 Q 70 48 58 56 Q 64 60 60 68 Q 56 76 46 72 Q 42 70 40 66" {...f} stroke={color} strokeWidth="2.5" /><line x1="40" y1="12" x2="40" y2="66" stroke={color} strokeWidth="1.5" strokeOpacity="0.5" /><path d="M 18 34 Q 28 30 36 36" stroke={color} strokeWidth="1.5" strokeOpacity="0.5" fill="none" strokeLinecap="round" /><path d="M 62 34 Q 52 30 44 36" stroke={color} strokeWidth="1.5" strokeOpacity="0.5" fill="none" strokeLinecap="round" /></svg>;
    case "meridian":
